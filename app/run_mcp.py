# run_mcp.py
import logging
from app.fastmcp_server import mcp
from mcp_config.agent_config import setup_mcp
...
# import jwt
# from agents.query_agent import QueryAgent  # 🧠 Agent using ReAct logic
...
#     "system": " ",       
# }
#     return agent.run(user_query=request.query, config=config, user=user)
